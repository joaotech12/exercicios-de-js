...
console.log("Seu IMC é: " + imc.toFixed(2)); //toFixed() serve para manter apenas as casas decimais, ñ esquecer 
...
if (imc < 18.5) {
    ...
    console.log("Obeso classe 1")
} else if (imc < 40){
    console.log("Obeso classe 2")
} else if (imc >= 40){
     console.log("Obeso clasee 3")
}
